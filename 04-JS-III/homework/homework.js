...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código:
  const nuevoElemento = array.push(elemento) ;
  return array;
}
...
function agregarItemAlComienzoDelArray(array, elemento) {
  ...
  // Tu código:
  const nuevoElementoAlIni = array.unshift(elemento) ;
  return array;
}
...
var sumass = 0 
  for(var i = 0; i < resultadosTest.length; i++) {
    sumass = sumass + resultadosTest[i];
  } var promedi = sumass / resultadosTest.length
  return promedi;
}
